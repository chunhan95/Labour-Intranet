<%@ Page Language="C#" MasterPageFile="~/Master page/Common.Master" AutoEventWireup="true" CodeBehind="90days.aspx.cs" Inherits="PrisMegahHRSystem.Expiry_Reminder._90days" %>
...
<asp:Content ID="myContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;
    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Lime"></asp:Label>
&nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="Lime"></asp:Label>
    <br />
    <br />
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(PLKSExp,'yyyy-MM-dd')) &lt;= 90 AND DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(PLKSExp,'yyyy-MM-dd')) &gt; 60) AND workerStatus='Available'"></asp:SqlDataSource>
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(passportExp,'yyyy-MM-dd')) &lt;= 90 AND DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(passportExp,'yyyy-MM-dd')) &gt; 60) AND workerStatus='Available'
"></asp:SqlDataSource>
