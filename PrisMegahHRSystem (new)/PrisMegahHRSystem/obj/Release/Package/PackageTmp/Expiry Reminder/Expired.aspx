<%@ Page Language="C#" MasterPageFile="~/Master page/Common.Master" AutoEventWireup="true" CodeBehind="Expired.aspx.cs" Inherits="PrisMegahHRSystem.Expiry_Reminder.Expired" %>
...
&nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
    <br />
    <br />
    <asp:GridView ID="gvPassport" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="1310px" OnRowCommand="gvPassport_RowCommand">
    ...
    <asp:GridView ID="gvPLKS" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Width="1310px" OnRowCommand="gvPLKS_RowCommand">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:TemplateField HeaderText="New Passport No" SortExpression="New Passport No">
                <EditItemTemplate>
    ...
    <asp:GridView ID="gvPassport2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1310px" OnRowCommand="gvPassport2_RowCommand">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:TemplateField HeaderText="New Passport No" SortExpression="New Passport No">
                <EditItemTemplate>
    ...
    <asp:GridView ID="gvPLKS2" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1310px" OnRowCommand="gvPLKS2_RowCommand">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:TemplateField HeaderText="New Passport No" SortExpression="New Passport No">
                <EditItemTemplate>
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(PLKSExp,'yyyy-MM-dd')) &lt;= 0) AND workerStatus='Available'"></asp:SqlDataSource>
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(passportExp,'yyyy-MM-dd')) &lt;= 0) AND workerStatus='Available'
"></asp:SqlDataSource>
