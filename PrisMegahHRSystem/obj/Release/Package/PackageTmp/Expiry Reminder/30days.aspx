<%@ Page Language="C#" MasterPageFile="~/Master page/Common.Master" AutoEventWireup="true" CodeBehind="30days.aspx.cs" Inherits="PrisMegahHRSystem.Expiry_Reminder._30days" %>
...
&nbsp;<asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="#FF9900"></asp:Label>
    <br />
    <br />
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(PLKSExp,'yyyy-MM-dd')) &lt;= 30 AND DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(PLKSExp,'yyyy-MM-dd')) &gt; 0) AND workerStatus='Available'"></asp:SqlDataSource>
...
FROM workerDetails
WHERE (DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(passportExp,'yyyy-MM-dd')) &lt;= 30 AND DATEDIFF(day, FORMAT(GETDATE(),'yyyy-MM-dd'), FORMAT(passportExp,'yyyy-MM-dd')) &gt; 0) AND workerStatus='Available'
"></asp:SqlDataSource>
